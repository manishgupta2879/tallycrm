...
@section('content')
    ...
    <script>
        ...
        @php
            ...
            // If no old values, but section shown, we should ideally know the current max.
            // But if it's the first edit load, c_urls are empty in old().
            $initialUrlIndex = $maxUrlIndex + 1;
            if ($initialUrlIndex < 1000) $initialUrlIndex = 1000; // Keep high for new ones
        @endphp
