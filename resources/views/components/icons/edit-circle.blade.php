<svg fill="currentColor" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
    stroke-width="0.4800000000000001" stroke-linecap="round" stroke-linejoin="round"
    height="{{ isset($height) ? $height : '24' }}" width="{{ isset($width) ? $width : '24' }}"
    color="{{ isset($color) ? $color : 'currentColor' }}"
